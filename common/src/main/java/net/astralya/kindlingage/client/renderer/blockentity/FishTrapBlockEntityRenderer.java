...
public final class FishTrapBlockEntityRenderer implements BlockEntityRenderer<FishTrapBlockEntity> {
  ...
  private static final float[] PILE_ROTATIONS = {
    0.0F, 27.5F, -18.0F, 41.0F, -33.0F, 14.0F, -9.0F, 36.0F
  };
  ...
  public void render(
    ...
    renderPile(
        ...
        packedOverlay,
        facing,
        new ItemStack(ModItems.WILD_SEEDS.get()),
        blockEntity.getBaitCount(),
        SEEDS_X,
        PILE_Z,
        17);
    ...
    renderPile(
        ...
        packedOverlay,
        facing,
        blockEntity.getCatchStack(),
        blockEntity.getCatchCount(),
        FISH_X,
        PILE_Z,
        53);
  }
